...
const Home = () => {
  ...
  const applyGlobalContextAttribute = () => {
    ...
    datadogRum.setGlobalContextProperty(
      "my_custom_attribute.message",
      "Congrats! You applied a global context attribute..."
    );
        ...
        <div className="container">
          <div className="row">
            <header className="App-header p-4">
              <h1>React Mongo Template - Dockerized</h1>
              ...
              <div className="row">
                <div className="col-md-12">
                  <div
                    ...
                    data-bs-theme="dark"
                    id="accordionAdditionalRumFunctions"
                  >
                    <div className="accordion-item">
                      <h2 className="accordion-header">
                        <button
                          ...
                          data-bs-target="#additional-rum-functions"
                          aria-expanded="false"
                      ...
                      <div
                        id="additional-rum-functions"
                        className="accordion-collapse collapse"
                        data-bs-parent="#accordionAdditionalRumFunctions"
                      >
                          ...
                          <div className="row mt-2">
                            <div className="col-md-6">
                              <button
                                ...
                                onClick={() => applyGlobalContextAttribute()}
                              >
          ...
          <div className="col-md-12 pt-3 pb-3">
            <a
              href="https://github.com/nick-ramsay/unified-rum-sandboxes/tree/main/react-mongo-template-docker"
              target="_blank"
              rel="noopener noreferrer"
